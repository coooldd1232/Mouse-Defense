...
class ShopItem:
    ...
    def __init__(self, cost, imagePath, pos, textDescription):
        self.cost = cost
        ...
        self.textCost = self.font.render(f'${self.cost}', True, (0, 0, 255))
        self.textCostRect = self.textCost.get_rect()
        self.textCostRect.center = self.pos.x + self.width / 2 - 5, self.pos.y + self.height + 20

        self.textDescription = self.font.render(textDescription, True, (0, 0, 255))
    ...
    def SetCost(self, cost):
        ...
        if self.canUpgrade:
            ...
            self.textCost = self.font.render(f"can't upgrade", True, (0, 0, 255))
            self.textCostRect = self.textCost.get_rect()
            self.textCostRect.center = self.pos.x + self.width / 2 - 5, self.pos.y + self.height + 20
